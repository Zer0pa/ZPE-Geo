...
<sub>02 · ZPE Geo animated mechanics diagram · b-cell b-codec-mechanics cell-5 row-2</sub>
<figure>
...
<div><b>02 · MARKETS</b><span>ADJACENT FORECASTS</span></div>
      <div>
        <div>
          <div><span>Maritime analytics &rsquo;31</span><span></span><span>$2.6 B</span></div>
          <div><span>Maritime analytics &rsquo;35</span><span></span><span>$7.6 B</span></div>
          <div><span>Maritime information &rsquo;30</span><span></span><span>$23.2 B</span></div>
          <div><span>Fleet telematics &rsquo;30</span><span></span><span>$36.2 B</span></div>
          <div><span>Autonomous vehicle data &rsquo;30</span><span></span><span>$11.5 B</span></div>
        </div>
      </div>
...
<div><b>05.3 · BENCHMARKS</b><span>DECLARED FIXTURES</span></div>
      <div>
        ...
        <div>
          <div><span>ZPE OSM</span><span></span><span>13.78×</span></div>
          <div><span>DP OSM</span><span></span><span>6.45×</span></div>
          <div><span>max-wave</span><span></span><span>0/2 MISS</span></div>
        </div>
      </div>
...
<div><b>06.1 · COMPARATIVE PERFORMANCE</b><span>OSM EXTRACT VS BASELINE</span></div>
      <div>
        <div>
          <div><span>ZPE-Geo OSM</span><span></span><span>13.78&times; smaller</span></div>
          <div><span>DP baseline</span><span></span><span>6.45&times;</span></div>
          <div><span>Argoverse2 max-wave</span><span></span><span>MISS</span></div>
          <div><span>NOAA max-wave</span><span></span><span>MISS</span></div>
        </div>
      </div>
